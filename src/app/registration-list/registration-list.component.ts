...
export class RegistrationListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'nombreLavadero', 'nombreResponsable', 'apellidoResponsable', 'telefono', 'email', 'direccion', 'tipoServicio', 'estado', 'paquete', 'oferta', 'socioNuevo','fechaActivacion', 'action'];
